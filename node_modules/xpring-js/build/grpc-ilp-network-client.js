...
class GrpcIlpNetworkClient {
    constructor(grpcURL) {
        if (utils_1.default()) {
            ...
            this.balanceClient = new balance_service_grpc_pb_1.BalanceServiceClient(grpcURL, grpc_1.credentials.createInsecure());
            this.paymentClient = new ilp_over_http_service_grpc_pb_1.IlpOverHttpServiceClient(grpcURL, grpc_1.credentials.createInsecure());
        }
        else {
